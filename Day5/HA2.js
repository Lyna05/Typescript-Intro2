...
function entferneElement(arr, wert) {
    return arr.filter(function (item) { return item !== wert; });
}
...
function findeMinMax(arr) {
    var min = arr[0]; // Initialisierung von min mit dem ersten Element des Arrays
    var max = arr[0]; // Initialisierung von max mit dem ersten Element des Arrays
